          ...
          { 
            ...
            <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
              ...
              <div class="nav-profile-text ">
                <p class="mb-1 text-dark"><?php  echo $row->ownername;?></p>
              </div>
            </a>
            <?php
          }
  ...
  <div class="navbar-menu-wrapper d-flex align-items-stretch w-100">
    ...
    <ul class="navbar-nav navbar-nav-left">
        <li class="nav-item dropdown">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link" href="manage_proposal.php">Proposals</a>
          </li>
         
        
		   <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Drivers</a>
            <div class="dropdown-menu  navbar-dropdown" aria-labelledby="dropdown05">
              <a class="dropdown-item" href="userregister.php">Manage Drivers</a>
		   ...
		   <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu  navbar-dropdown" aria-labelledby="dropdown05">
              <a class="dropdown-item" href="payment_history.php">Payments History</a>
